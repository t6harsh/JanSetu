...
const mockBills = {
    electricity: { name: 'Guest User', id: 'ELEC-292847', period: 'Jan 2026 - Feb 2026', amount: '₹2,340', due: '15 Mar 2026', units: '284 kWh', rate: '₹8.24/kWh' },
    gas: { name: 'Guest User', id: 'GAS-104827', period: 'Jan 2026 - Feb 2026', amount: '₹890', due: '20 Mar 2026', units: '12.4 SCM', rate: '₹71.78/SCM' },
    water: { name: 'Guest User', id: 'WTR-382910', period: 'Jan 2026 - Feb 2026', amount: '₹450', due: '10 Mar 2026', units: '18 KL', rate: '₹25/KL' },
    waste: { name: 'Guest User', id: 'WST-019283', period: 'Jan 2026 - Feb 2026', amount: '₹200', due: '28 Feb 2026', units: 'Residential', rate: 'Flat Rate' },
    property: { name: 'Guest User', id: 'PROP-583921', period: 'FY 2025-2026', amount: '₹8,500', due: '31 Mar 2026', units: '1200 sq.ft', rate: '₹7.08/sq.ft' },
};

const paymentMethodKeys = ['payment_upi', 'payment_debit', 'payment_netbanking', 'payment_cash'];

export default function QuickBillPayment() {
    ...
    return (
        <div className="animate-fade-in">
            ...
            <div className="breadcrumb">
                <a onClick={() => navigate('/')} style={{ cursor: 'pointer' }}>{t('home')}</a>
                <span className="breadcrumb__separator">›</span>
                <span>{t('quick_bill_payment')} — {t(serviceInfo.labelKey)}</span>
            </div>
                ...
                {Object.entries(serviceIcons).map(([key, info]) => {
                    ...
                    return (
                        <button
                            ...
                            onClick={() => { navigate(`/quick-bill-payment?service=${key}`); setWizardStep(1); setConsumerId(''); }}
                        >
            ...
            {wizardStep === 1 && (
                <div className="panel animate-fade-in" style={{ maxWidth: '600px', margin: '0 auto' }}>
                    <div className="panel__header">
                        ...
                        <h2 className="panel__title">{t(serviceInfo.labelKey)} — {t('quick_bill_payment')}</h2>
                    </div>
            ...
            {wizardStep === 4 && (
                <div className="panel animate-scale-in" style={{ maxWidth: '600px', margin: '0 auto' }}>
                    <div className="success-screen">
                        ...
                        <button className="btn btn-secondary btn-block" onClick={() => navigate('/')} style={{ marginTop: '1rem' }}>
